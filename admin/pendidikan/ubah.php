...
if(isset($_POST['submit'])){
	if(ubah($_POST) > 0){
		echo "
				<script>
					alert('DATA PENDIDIKAN BERHASIL DI UBAH!');
...
<html lang="en">
  <head>
    ...
    <title>Ubah Data Pendidikan</title>
    ...
    <div class="containe">
        ...
        <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-sm-10 offset-sm-1">
            <div class="card mt-5 mb-5 p-5" id="card" data-aos="flip-up" data-aos-duration="2000">
                        <h3 class="text-center mt-2 mb-4">Ubah Data Pendidikan</h3>
            ...
            <input type="hidden" name="id_pendidikan" value="<?php echo $pendidikan['id_pendidikan']; ?>">
                ...
                <div class="mb-3">
                    <input type="text" class="form-control" name="pendidikan" placeholder="Pendidikan....." autofocus id="pendidikan"  value="<?php echo $pendidikan['pendidikan']; ?>">
                </div>
