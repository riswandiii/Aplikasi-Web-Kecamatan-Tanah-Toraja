...
if(isset($_POST['registrasi'])){
	if(tambah($_POST) > 0){
		echo "
				<script>
					alert('DATA KELURAHAN BERHAIL DITAMBAH!');
    ...
    <div class="containe">
        ...
        <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-sm-10 offset-sm-1">
            <div class="card mt-5 mb-5 p-5" id="card" data-aos="flip-up" data-aos-duration="2000">
                        <h3 class="text-center mt-2 mb-4">Tambah Data Kelurahan</h3>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <input type="text" class="form-control" name="nama_kelurahan" placeholder="Nama Kelurahan....." autofocus id="nama_kelurahan">
                </div>
