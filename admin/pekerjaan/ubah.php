...
$pekerjaan = query("SELECT * FROM tb_pekerjaan WHERE id_pekerjaan = $id_pekerjaan")[0];
...
if(isset($_POST['submit'])){
	if(ubah($_POST) > 0){
		echo "
				<script>
					alert('DATA PEKERJAAN BERHASIL DI UBAH!');
...
<html lang="en">
  <head>
    ...
    <title>Ubah Data PEKERJAAN</title>
    ...
    <div class="containe">
        ...
        <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-sm-10 offset-sm-1">
            <div class="card mt-5 mb-5 p-5" id="card" data-aos="flip-up" data-aos-duration="2000">
                        <h3 class="text-center mt-2 mb-4">Ubah Data PEKERJAAN</h3>
            ...
            <div class="mb-3">
                <input type="text" class="form-control" name="pekerjaan" placeholder="Pekerjaan....." autofocus id="pekerjaan"  value="<?php echo $pekerjaan['pekerjaan']; ?>">
            </div>
